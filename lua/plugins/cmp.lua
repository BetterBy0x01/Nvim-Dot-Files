return {
	...
	-- cmp-nvim-lsp provide language specific completion suggestions to nvim-cmp
	{
		"hrsh7th/cmp-nvim-lsp",
	},
	-- nvim-cmp provides auto completion and auto completion dropdown vi
	{
		"hrsh7th/nvim-cmp",
		event = "InsertEnter",
		dependencies = {
