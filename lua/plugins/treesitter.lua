return {
    ...
    config = function()
        ...
        -- call the treesittre setup function with properties to configure our experience
        ts_config.setup({
            -- make sure we have vim, vimdoc, lua, python, java, javascript, typescript, 
            -- html, css, json, tsx, markdown, inline markdown and gitignore highlighting servers
            ensure_installed = {"vim", "vimdoc", "lua", "python", "java", "javascript", "typescript",
            "html", "css", "json", "tsx", "markdown", "markdown_inline", "gitignore"},
